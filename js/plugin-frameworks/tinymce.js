! function(j) {
	...
	var tt, nt, rt, ot, it = function(e) {
			...
			Ot = Mt,
			Ht = de().browser.isIE() ? function(e, t) {
	...
	tt = undefined, nt = an, rt = un, ot = undefined,
			function(e) {
	...
	var ln, fn, dn, hn = un.exports.boltExport,
			mn = function(e) {
					var n = D.none(),
							t = [],
							r = function(e) {
			...
			Jn = {
					...
					extend: function(e, t) {
							...
							for (n = 1, r = c.length; n < r; n++)
									for (o in t = c[n]) t.hasOwnProperty(o) && (u = t[o]) !== undefined && (e[o] = u);
							return e
					},
					create: function(e, t, n) {
							...
							if (e = /^((static) )?([\w.]+)(:([\w.]+))?/.exec(e), i = e[3].match(/(^|\.)(\w+)$/i)[2], !(o = c.createNS(e[3].replace(/\.\w+$/, ""), n))[i]) {
									...
									t[i] || (t[i] = function() {}, s = 1), o[i] = t[i], c.extend(o[i].prototype, t), e[5] && (r = c.resolve(e[5]).prototype, a = e[5].match(/\.(\w+)$/i)[1], u = o[i], o[i] = s ? function() {
	...
	function Lr(i) {
			...
			var t, n, r, o, a, u, c, s, l, f, d, h, m, z = {},
					g = {},
					E = [],
					p = {},
					v = {};
			...
			function y(e) {
					var t, n, r, o, i, a, u, c, s, l, f, d, h, m, g, p, v, y, b, C = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
							w = /^([!\-])?(\w+[\\:]:\w+|[^=:<]+)?(?:([=:<])(.*))?$/,
							x = /[*?+]/;
					if (e)
	...
	var qr = "\ufeff",
					...
					return {
							...
							parse: function(e) {
									...
									if (e) {
											for (e = (e = e.replace(/[\u0000-\u001F]/g, "")).replace(/\\[\"\';:\uFEFF]/g, r).replace(/\"[^\"]+\"|\'[^\']+\'/g, function(e) {
													...
													if (z.lastIndex = c.index + c[0].length, s = c[1].replace(E, "").toLowerCase(), l = c[2].replace(E, ""), s && l) {
							...
							serialize: function(i, e) {
									function t(e) {
											var t, n, r, o;
											if (t = s[e])
													for (n = 0, r = t.length; n < r; n++) e = t[n], (o = i[e]) && (c += (0 < c.length ? " " : "") + e + ": " + o + ";")
									}
									var n, r, o, a, u, c = "";
									if (e && s) t("*"), t(e);
									else
											for (n in i) !(r = i[n]) || l && (o = n, a = e, u = void 0, (u = l["*"]) && u[o] || (u = l[a]) && u[o]) || (c += (0 < c.length ? " " : "") + n + ": " + r + ";");
									return c
							}
					}
			},
			...
			Zr = (Jr.prototype.bind = function(e, t, n, r) {
					...
					if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
							...
							var m = t.split(" ");
							for (u = m.length; u--;) l = o, s = f = !1, "DOMContentLoaded" === (c = m[u]) && (c = "ready"), d.domLoaded && "ready" === c && "complete" === e.readyState ? n.call(r, Ur({
									type: c
	...
	for (eo in to = Qo.support = {}, oo = Qo.isXML = function(e) {
					...
					var t, c = e ? e.ownerDocument || e : Co,
							n = c.defaultView;
					...
					filter: {
							...
							CHILD: function(h, e, t, m, g) {
									...
									return 1 === m && 0 === g ? function(e) {
											...
											var r, o, i, a, u, c, s = p != v ? "nextSibling" : "previousSibling",
													l = e.parentNode,
											...
											if (l) {
													...
													if (c = [v ? l.firstChild : l.lastChild], v && d) {
															for (u = (r = (o = l[bo] || (l[bo] = {}))[h] || [])[0] === wo && r[1], a = r[0] === wo && r[2], i = u && l.childNodes[u]; i = ++u && i && i[s] || (a = u = 0) || c.pop();)
																	if (1 === i.nodeType && ++a && i === e) {
																			o[h] = [wo, u, a];
																			break
																	}
													} else if (d && (r = (e[bo] || (e[bo] = {}))[h]) && r[0] === wo) a = r[1];
													else
															for (;
																	(i = ++u && i && i[s] || (a = u = 0) || c.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[bo] || (i[bo] = {}))[h] = [wo, a]), i !== e)););
					...
					pseudos: {
							...
							lang: ti(function(n) {
									return qo.test(n || "") || Qo.error("unsupported lang: " + n), n = n.replace(Jo, Qr).toLowerCase(),
											function(e) {
													var t;
													do {
	...
	function di(m, g, p, v, y, e) {
			return v && !v[bo] && (v = di(v)), y && !y[bo] && (y = di(y, e)), ti(function(e, t, n, r) {
					var o, i, a, u = [],
							...
							d = p ? y || (e ? m : s || v) ? [] : t : f;
					if (p && p(f, d, n, r), v)
							for (o = fi(d, c), v(o, [], n, r), i = o.length; i--;)(a = o[i]) && (d[c[i]] = !(f[c[i]] = a));
					if (e) {
							if (y || m) {
									if (y) {
	...
	ui.prototype = no.filters = no.pseudos, no.setFilters = new ui, io = Qo.tokenize = function(e, t) {
			...
			if (n = n || [], 1 === l.length) {
					...
					for (o = $o.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !no.relative[u = a.type]);)
			...
			Ai = function(e, t, n, r) {
					...
					if (gi(t)) t = pi(t, Pi(e[0]));
							...
							if (t = Fi.makeArray(t), r)
									...
									for (o = 0; o < t.length; o++) Ai(e, t[o], n, r);
							return e
					}
					if (t.nodeType)
	...
	bi.fn = bi.prototype = {
			...
			init: function(e, t) {
					...
					if (gi(e)) {
							...
							if (n[1])
									for (r = pi(e, Pi(t)).firstChild; r;) Ei.call(o, r), r = r.nextSibling;
							else {
			...
			add: function(e, t) {
					...
					if (!1 !== t)
							for (n = Fi.unique(this.toArray().concat(Fi.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r];
					...
					e = function U(m, g) {
							...
							function n(e, t, n) {
									...
									if (e = Jn._addCacheSuffix(e), y[e] ? l = y[e] : (l = {
											...
											if (2 !== l.status)
													if (3 !== l.status) {
															if (l.status = 1, (u = m.createElement("link")).rel = "stylesheet", u.type = "text/css", u.id = "u" + v++, u.async = !1, u.defer = !1, s = (new Date).getTime(), g.contentCssCors && (u.crossOrigin = "anonymous"), g.referrerPolicy && tn(at.fromDom(u), "referrerpolicy", g.referrerPolicy), "onload" in u && !((h = j.navigator.userAgent.match(/WebKit\/(\d*)/)) && parseInt(h[1], 10) < 536)) u.onload = f, u.onerror = i;
															else {
	...
	var cu, su = $("mce-annotation"),
			...
			Wu = function(e) {
					...
					if (Ou(e.container()))
							if (e.isAtEnd()) o = ju(e.container(), e.offset()), Iu(o) && t(o, o.data.length), Lu(o) && !Fu(o) && r(uu($u(o), !1));
							else {
	...
	function Gu(e, t) {
			...
			return n = t.container(), r = t.offset(), Fc(n) ? o = function(e, t) {
					for (;
							(e = e.previousSibling) && Fc(e);) t += e.data.length;
					return t
	...
	function uc(e, t) {
			...
			return Qu(n, r, l), e.moveToBookmark({
					id: o,
					keep: 1
			}), {
					id: o
	...
	function ul(e, t, n) {
			var r, o, i, a, u, c, s = e.get(n.id + "_" + t),
					l = n.keep;
			if (s) {
	...
	function fl(e, t, n) {
			...
			if ((n.startContainer !== n.endContainer || ! function(e) {
					...
					for (a < (i = u.childNodes).length ? (u = i[a], r = new Ui(u, e.getParent(u, e.isBlock))) : (u = i[i.length - 1], (r = new Ui(u, e.getParent(u, e.isBlock))).next(!0)), o = r.current(); o; o = r.next())
							if (3 === o.nodeType && !Gl(o)) return n.setStart(o, 0), void t.setRng(n)
	}
	...
	function Tl(e, t, n, r, o, i, a) {
			...
			for (;;) {
					...
					for (s = c[l]; s; s = s[l])
							if (!Zl(s) && !Ql(s) && ("BR" !== (d = s).nodeName || !d.getAttribute("data-mce-bogus") || d.nextSibling)) return c;
	...
	var Rl, Dl = en.isContentEditableFalse,
			_l = en.isText,
			Ol = en.isElement,
			Hl = en.isBr,
			Bl = $a,
	...
	function bf(q, $) {
			...
			function e() {}!1 !== (q = q || {}).fix_self_closing && (q.fix_self_closing = !0);
					...
					parse: function(i, e) {
							...
							function r(e, t, n, r, o) {
									...
									if (n = (t = t.toLowerCase()) in p ? t : L(n || r || o || ""), y && !h && !1 === function(e) {
											...
											if (!(i = z[t]) && E) {
													for (a = E.length; a-- && !(i = E[a]).pattern.test(t);); - 1 === a && (i = null)
											}
											if (!i) return;
							...
							for (M = new RegExp("<(?:(?:!--([\\w\\W]*?)--!?>)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:![Dd][Oo][Cc][Tt][Yy][Pp][Ee]([\\w\\W]*?)>)|(?:!(--)?)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), R = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, g = $.getShortEndedElements(), A = q.self_closing_elements || $.getSelfClosingElements(), p = $.getBoolAttrs(), y = q.validate, m = q.remove_internals, O = q.fix_self_closing, D = $.getSpecialElements(), T = i + ">"; o = M.exec(T);) {
									var U = o[0];
									if (H < o.index && X(L(i.substr(H, o.index - H))), u = o[7]) ":" === (u = u.toLowerCase()).charAt(0) && (u = u.substr(1)), t(u);
									else if (u = o[8]) {
											...
											if (!y || (b = $.getElementRule(u))) {
													if (C = !0, y && (z = b.attributes, E = b.attributePatterns), (x = o[9]) ? ((h = -1 !== x.indexOf("data-mce-type")) && m && (C = !1), (s = []).map = {}, x.replace(R, r)) : (s = []).map = {}, y && !h) {
															if (N = b.attributesRequired, S = b.attributesDefault, k = b.attributesForced, b.removeEmptyAttrs && !s.length && (C = !1), k)
																	for (l = k.length; l--;) d = (w = k[l]).name, "{$uid}" === (_ = w.value) && (_ = "mce_" + P++), s.map[d] = _, s.push({
																			name: d,
																			value: _
																	});
															if (S)
																	for (l = S.length; l--;)(d = (w = S[l]).name) in s.map || ("{$uid}" === (_ = w.value) && (_ = "mce_" + P++), s.map[d] = _, s.push({
																			name: d,
																			value: _
																	}));
															if (N) {
																	for (l = N.length; l-- && !(N[l] in s.map);); - 1 === l && (C = !1)
															}
	...
	function wf(e, t, n) {
			var r;
			if (t.format = t.format ? t.format : "html", t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) r = Jn.trim(md.trimExternal(e.serializer, n.innerHTML));
	...
	function Ff(r, e) {
			...
			Ad(t), t.on("focusin", function() {
					...
					t = e.target, n && t.ownerDocument === j.document && (t === j.document.body || If(n, t) || r.focusedEditor !== n || (n.fire("blur", {
							focusedEditor: null
					}), r.focusedEditor = null))
	...
	function Jf(e) {
			if (!e.removed) {
					...
					r && e.save({
									is_removing: !0
							}), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && o && Ld.remove(o.nextSibling),
							function(e) {
									e.fire("remove")
	...
	function hh(r, a) {
			...
			var H = function() {
							...
							e("width", b), e("height", C), z.unbind(N, "mousemove", _), z.unbind(N, "mouseup", H), S !== N && (z.unbind(S, "mousemove", _), z.unbind(S, "mouseup", H)), z.remove(c), z.remove(s), B(u),
									function(e, t, n, r) {
					...
					B = function(e) {
							var t, r, o, n, i;
							P(), L(), t = z.getPos(e, A), m = t.x, g = t.y, i = e.getBoundingClientRect(), r = i.width || i.right - i.left, o = i.height || i.bottom - i.top, u !== e && (u = e, b = C = 0), n = a.fire("ObjectSelected", {
									target: e
	...
	function xh(e, t) {
			var n = function(e, t) {
							var n = Ne(e);
							if (0 === n.length || Ch(e)) return {
									element: e,
									offset: t
							};
							if (t < n.length && !Ch(n[t])) return {
									element: n[t],
									offset: 0
							};
							var r = n[n.length - 1];
					...
					g = {
							...
							getSelectedBlocks: function(e, t) {
									return function(e, t, n, r) {
											var o, i, a = [];
											if (i = e.getRoot(), n = e.getParent(n || cm(i, t, t.collapsed), e.isBlock), r = e.getParent(r || sm(i, t, t.collapsed), e.isBlock), n && n !== i && a.push(n), n && r && n !== r)
													for (var u = new Ui(o = n, i);
					...
					e = {
							...
							parse: function(e, a) {
									...
									if (t.parse(e, a.format), v && h.length && (a.context ? a.invalid = !0 : function(e) {
													...
													for (d = rg("tr,td,th,tbody,thead,tfoot,table"), l = A.getNonEmptyElements(), f = A.getWhiteSpaceElements(), h = A.getTextBlockElements(), m = A.getSpecialElements(), t = 0; t < e.length; t++)
			...
			return function(e, g) {
					...
					g.remove_trailing_brs && e.addNodeFilter("br", function(e, t, n) {
							...
							if (!g.allow_unsafe_link_target)
									for (; o--;) "a" === (t = e[o]).name && "_blank" === t.attr("target") && t.attr("rel", (n = t.attr("rel"), void 0, r = n ? Jn.trim(n) : "", /\b(noopener)\b/g.test(r) ? r : r.split(" ").filter(function(e) {
											return 0 < e.length
			...
			if (s)
					if ("undefined" == typeof s.length) {
							...
							for (c = 0; c < s.length; c++)
									if ("attributes" === r ? e.getAttrib(t, s[c]) : yl(e, t, s[c])) return n;
			return n
	}
	...
	function zg(e, t) {
			var n, r, o, i, a, u = e.formatter.get(t),
					c = e.dom;
			if (u)
					for (n = e.selection.getStart(), r = Cl(c, n), i = u.length - 1; 0 <= i; i--) {
	...
	var Gg, Zg, Jg = 0,
			...
			op = function(e, t, n, r, o) {
					var i, a, u, c, s = e.formatter.get(n),
							l = e.dom;
					if (s && t)
							for (a = 0; a < s.length; a++)
									if (i = s[a], bg(e.dom, t, i) && Cg(l, t, i, "attributes", o, r) && Cg(l, t, i, "styles", o, r)) {
											if (c = i.classes)
			...
			sp = function(t, n, e, r) {
					...
					var o = Hg(n, t.getBody(), e.dom()),
							i = Na(e, d(Pg, t), function(t) {
									return function(e) {
											return e.dom() === t
									}
							}(t.getBody())),
							a = Vg(e, o, function(e, t) {
	...
	function xp(u, n, a, e, r) {
			...
			var o, i, l = u.formatter.get(n),
					...
					g = function(e) {
							var t, n, r, o, i;
							if (en.isElement(e) && h.getContentEditable(e) && (o = d, d = "true" === h.getContentEditable(e), i = !0), t = Jn.grep(e.childNodes), d && !i)
			...
			if (e) ll(e) ? ((i = h.createRng()).setStartBefore(e), i.setEndAfter(e), t(i)) : t(e);
			...
			}(u, n, a, r) : (o = Kc.getPersistentBookmark(u.selection, !0), t(m.getRng()), m.moveToBookmark(o), f.inline && wg(u, n, a, m.getStart()) && fl(h, m, m.getRng()), u.nodeChanged());
			else {
					e = m.getNode();
	...
	var Dp = Jn.each,
			...
			Fp = function(m, g, p, r) {
					...
					if ("false" !== i.getContentEditable(a.getNode())) {
							if (C) {
									if (r) ll(r) ? y(b, r) || ((n = i.createRng()).setStartBefore(r), n.setEndAfter(r), e(i, Al(m, n, b), 0, !0)) : e(i, r, 0, !0);
							...
							for (var c = 0, s = b.length; c < s; c++)
									if (b[c].ceFalseOverride && i.is(r, b[c].selector)) return void v(r, b[c])
					}
			},
			Up = function(r, e, t, n) {
					var o = J(t.get()),
	...
	function tv(e) {
			...
			return _a(t, ev(e)), U(wa(t, "*[data-mce-bogus]"), Oe),
					function(e) {
			...
			var r = ut(D.none()),
					...
					a = {
							...
							undo: function() {
									return function(e, t, n, r) {
											var o;
											return t.typing && (t.add(), t.typing = !1, rv(t, !1, n)), 0 < r.get() && (r.set(r.get() - 1), o = t.data[r.get()], ny(e, o, !0), e.setDirty(!0), e.fire("Undo", {
													level: o
											})), o
									}(n, a, o, i)
							},
							redo: function() {
									return function(e, t, n) {
											var r;
											return t.get() < n.length - 1 && (t.set(t.get() + 1), r = n[t.get()], ny(e, r, !1), e.setDirty(!0), e.fire("Redo", {
													level: r
											})), r
									}(n, i, a.data)
							},
	...
	function dv(e) {
			var t, n, r, o, i, a, u, c, s, l, f = e.dom,
					d = e.selection,
					h = e.schema,
			...
			if (g && en.isElement(g) && v && (l = p.nodeName.toLowerCase(), h.isValidChild(l, v.toLowerCase()) && ! function(t, e, n) {
					...
					for (n = (t = d.getRng()).startContainer, r = t.startOffset, o = t.endContainer, i = t.endOffset, s = Bd(e), g = p.firstChild; g;)
							if (y = m, b = g, en.isText(b) || en.isElement(b) && !lv(y, b) && !Xl(b)) {
									if (fv(m, g)) {
	...
	var Ow = d(ob, Ku.isAbove, -1),
			...
			ix = function(e) {
					...
					return en.isContentEditableTrue(n) && e.dom.isBlock(n) && e.dom.isEmpty(n) && (t = e.dom.create("br", {
							"data-mce-bogus": "1"
					}), e.dom.setHTML(n, ""), n.appendChild(t), e.selection.setRng(Ic.before(t).toRange())), !0
			},
			ax = function(e, t) {
					return function(e, t) {
			...
			Tx = function(a, e) {
					function t(e) {
							...
							if (r = t = e || "TABLE" === m || "HR" === m ? y.create(e || p) : s.cloneNode(!1), !1 === fs(a)) y.setAttrib(t, "style", null), y.setAttrib(t, "class", null);
							else
									do {
											if (i[o.nodeName]) {
					...
					var o, u, c, i, s, l, f, d, h, m, g, p, v, y = a.dom,
							b = a.schema,
					...
					}(y, s), y.isEmpty(s) && jC(s), f.normalize(), y.isEmpty(f) ? (y.remove(f), r()) : (YC(a, f), xx(a, f))), y.setAttrib(f, "id", ""), a.fire("NewBlock", {
							newBlock: f
					})))
			},
			Ax = function(e, t) {
	...
	function $x(r) {
			...
			"onselectionchange" in r.getDoc() || r.on("NodeChange click mouseup keyup focus", function(e) {
					...
					!e || !Kn.range && r.selection.isCollapsed() || Ih(r) && !t.isSameElementPath(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({
							selectionChange: !0
					})
	...
	function tz(g) {
			...
			return Kn.ceFalse && function() {
					...
					(n = g).on("tap", function(e) {
							...
							var t, n = e.target;
							if ((n === y || "HTML" === n.nodeName || g.dom.isChildOf(n, y)) && !1 !== Qd(g, e.clientX, e.clientY))
									if (t = ez(g, n)) Hz(t) ? (e.preventDefault(), c(_y(g, t))) : (s(), Oz(t) && e.shiftKey || gh(e.clientX, e.clientY, g.selection.getRng()) || (w(), g.selection.placeCaretAt(e.clientX, e.clientY)));
									else if (!1 === xc(n)) {
									s(), w();
	...
	function rz(e) {
			e.bindPendingEventDelegates(), e.initialized = !0,
					function(e) {
							e.fire("Init")
					}(e), e.focus(!0),
					function(r) {
	...
	function bz(e, t, n) {
			var r, o, i, a, u, c, s, l, f, d, h, m = e.selection,
					g = e.dom;
			if (/^ | $/.test(t) && (t = function(e, t) {
					...
					}(m.getRng(), t)), r = e.parser, h = n.merge, o = zf({
							validate: e.settings.validate
					}, e.schema), d = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', c = {
							content: t,
							format: "html",
							selection: !0,
							paste: n.paste
	...
	var Tz = function(e, t) {
			...
			Pz = function(t, e) {
					...
					o.inline || (t.getElement().style.visibility = t.orgVisibility), e || t.inline || (a.open(), a.write(t.iframeHTML), a.close()), t.inline && (t.on("remove", function() {
							...
							}(t), t.serializer = Jm(o, t), t.selection = jm(t.dom, t.getWin(), t.serializer, t), t.annotator = sf(t), t.formatter = Yp(t), t.undoManager = iv(t), t._nodeChangeDispatcher = new qx(t), t._selectionOverrides = tz(t), ay(t), Wx(t), Xx(t), jx(t), uy(t), cv(t),
							function(e) {
									e.fire("PreInit")
							}(t), o.browser_spellcheck || o.gecko_spellcheck || (a.body.spellcheck = !1, Bz.setAttrib(n, "spellcheck", "false")), t.quirks = nz(t),
							function(e) {
									e.fire("PostRender")
							}(t);
					var u = Ds(t);
	...
	var iE = Jn.makeMap("focus blur focusin focusout click dblclick mousedown mouseup mousemove mouseover beforepaste paste cut copy selectionchange mouseout mouseenter mouseleave wheel keydown keypress keyup input beforeinput contextmenu dragstart dragend dragover draggesture dragdrop drop drag submit compositionstart compositionend compositionupdate touchstart touchmove touchend touchcancel", " "),
			aE = (uE.isNative = function(e) {
					...
					if (e = e.toLowerCase(), (t = t || {}).type = e, t.target || (t.target = this.scope), t.preventDefault || (t.preventDefault = function() {
							...
							}, t.isDefaultPrevented = s, t.isPropagationStopped = s, t.isImmediatePropagationStopped = s), this.settings.beforeFire && this.settings.beforeFire(t), n = this.bindings[e])
							for (r = 0, o = n.length; r < o; r++) {
	...
	function yE(e, t, n, r) {
			...
			o.deactivate(), o.editorReadOnly !== i.editorReadOnly && dE(e, i.editorReadOnly), t.set(r),
					function(e, t) {
							e.fire("SwitchMode", {
									mode: t
							})
	...
	var VE = ea.DOM,
			...
			qE = ($E.prototype.render = function() {
					...
					e === undefined ? Gf(this, this.startContent, {
							format: "raw"
					}) : Gf(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
			...
			aN = ne(ne({}, wE), {
					...
					add: function(e) {
							...
							return rN[e.id] === e || (null === n.get(e.id) && (function(e) {
									return "length" !== e
							}(e.id) && (rN[e.id] = e), rN.push(e), oN.push(e)), KE(!0), n.activeEditor = e, n.fire("AddEditor", {
									editor: e
							}), YE || (YE = function(e) {
					...
					remove: function(e) {
							var t, n, r = this;
							if (e) {
									if (!K(e)) return n = e, H(r.get(n.id)) ? null : (XE(n) && r.fire("RemoveEditor", {
											editor: n
									}), 0 === oN.length && window.removeEventListener("beforeunload", YE), n.remove(), KE(0 < oN.length), n);
			...
			CN = {
					...
					findBestRelativePosition: function(e, t, n, r) {
							...
							for (i = 0; i < r.length; i++)
									if ((o = cN(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
							return null
					},
	...
	var zN = Math.min,
			...
			TN = ne(ne({}, wE), {
					send: function(e) {
							...
							if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", TN.fire("beforeInitialize", {
											settings: e
	...
	var BN, PN = {
			...
			LN = Jn.extend(aN, PN);
	BN = LN, window.tinymce = BN, window.tinyMCE = BN,
			function(e) {
...
! function(u) {
	...
	return function() {
			var n, t, r = tinymce.defaultSettings,
					e = {
							load: function(n) {
									return s
							}
